defmodule SmileysWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Smileysweb.MyChannel do
        use Smileysweb.Web, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :smileys,
                        pubsub_server: Smileys.PubSub
end
