...
var Elm = {};
Elm['SmileysSearch'] = Elm['SmileysSearch'] || {};
if (typeof _user$project$SmileysSearch$main !== 'undefined') {
    _user$project$SmileysSearch$main(Elm['SmileysSearch'], 'SmileysSearch', {"types":{"unions":{"SmileysSearch.Msg":{"args":[],"tags":{"LeaveChannel":[],"ShowLeftMessage":["String"],"JoinChannel":[],"Presses":["Char"],"UpdateSearchTerm":["String"],"PageDown":[],"PhoenixMsg":["Phoenix.Socket.Msg SmileysSearch.Msg"],"ReceiveSearchResults":["Json.Encode.Value"],"RequestSearch":[],"CloseSearch":[],"ShowJoinedMessage":["String"],"PageUp":[],"NoOp":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"SmileysSearch.Msg"},"versions":{"elm":"0.18.0"}});
}
